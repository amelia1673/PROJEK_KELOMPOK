...
public class registrasi extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jenkel, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(hp, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 331, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void bregisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bregisActionPerformed
        String id_teknisi = this.id_teknisi.getText().trim();
        String password = new String(sandi.getPassword());
        String confirmPassword = new String(knf_sandi.getPassword());
        String nama = this.nama.getText().trim();
        String jenisKelamin = (String) this.jenkel.getSelectedItem();
        String hp = this.hp.getText().trim();

        if (id_teknisi.isEmpty() || password.isEmpty() || confirmPassword.isEmpty() || nama.isEmpty() || jenisKelamin == null || hp.isEmpty()) {
        ...
        String sql = "INSERT INTO tb_login (id_teknisi, sandi, nama, jenkel, hp) VALUES (?, ?, ?, ?, ?)";
        try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
            pstmt.setString(1, id_teknisi);
